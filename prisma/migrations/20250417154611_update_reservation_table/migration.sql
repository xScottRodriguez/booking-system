/*
  ...
  - You are about to drop the column `client_name` on the `reservation` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "reservation" DROP COLUMN "client_name",
